...
func main() {
	...
	orgSync := mycontentapiclient.Sync(orgClient, sampleOrg, "pt-angin-ribut")

	userSync := mycontentapiclient.Sync(userClient, sampleUser, "pt-angin-ribut").
		WithImages(userThumbnailClient, getUserProfileImage, ".")
...
func getUserProfileImage(users []*entity.UserProfile) (imageRefs []mycontentapiclient.ImageContextPair[*entity.UserProfile]) {
	for idx := range users {
		imageRefs = append(imageRefs, mycontentapiclient.ImageContextPair[*entity.UserProfile]{
